<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signin.aspx.cs" Inherits="fullweb.admin.signin" %>
		 ...
		 <div class="card-content p-2">
		  ...
		  <div class="card-title text-uppercase text-center py-3">Sign In</div>
			  ...
			  <label for="exampleInputUsername" class="sr-only">Username</label>
			   <div class="position-relative has-icon-right">
				 <%-- <input type="text" id="exampleInputUsername" class="form-control input-shadow" placeholder="Enter Username">--%>
				   <asp:TextBox ID="txt_email" runat="server" class="form-control input-shadow" placeholder="Enter Username"></asp:TextBox>
			  ...
			  <label for="exampleInputPassword" class="sr-only">Password</label>
			   <div class="position-relative has-icon-right">
				 <%-- <input type="password" id="exampleInputPassword" class="form-control input-shadow" placeholder="Enter Password">--%>
				   <asp:TextBox ID="txt_pass" runat="server" class="form-control input-shadow" placeholder="Enter Password"></asp:TextBox>
				  <div class="form-control-position">
					  <i class="icon-lock"></i>
				  </div>
			   </div>
			...
			<%-- <button type="button" class="btn btn-primary btn-block">Sign In</button>--%>
				<asp:Button ID="Button1" runat="server" Text="Button" class="btn btn-primary btn-block" OnClick="Button1_Click"/>
