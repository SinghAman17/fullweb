<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="country.aspx.cs" Inherits="fullweb.admin.WebForm1" %>
			     ...
			     <div class="card-body">
				   ...
				   <hr>
					...
					<%--	<input type="text" class="form-control" id="input-21" placeholder="Enter Your Name">--%>
						  <asp:TextBox ID="txt_name" runat="server" class="form-control"  placeholder="Enter Your Name"></asp:TextBox>
					  </div>
					</div>
