<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="categoryform.aspx.cs" Inherits="fullweb.admin.WebForm10" %>
			     ...
			     <div class="card-body">
				   ...
				   <hr>
					...
					<%--	<input type="text" class="form-control" id="input-21" placeholder="Enter Your Name">--%>
						  <asp:TextBox ID="txt_cname" runat="server" class="form-control"></asp:TextBox>
					  </div>
					</div>
					  ...
					  <div class="col-sm-10">
					<%--	<input type="text" class="form-control" id="input-21" placeholder="Enter Your Name">--%>
						  <asp:TextBox ID="txt_cdesc" runat="server" class="form-control"></asp:TextBox>
					  </div>
					</div>
					  ...
					  <div class="col-sm-10">
					<%--	<input type="text" class="form-control" id="input-21" placeholder="Enter Your Name">--%>
						  <asp:DropDownList runat="server" Id="ddl_cat" class="form-control">
					 ...
					 <div class="form-group row">
					  ...
					  <div class="col-sm-10">
						<%--<button type="submit" class="btn btn-primary px-5">--%>
						  <asp:Button runat="server" Id="btn_insert" Text="Button" class="btn btn-primary px-5" OnClick="btn_insert_Click"/>
